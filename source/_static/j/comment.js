 ...
 */
DESELEMENT = "h2,h3,h4,.highlight,.highlight-js,.highlight-json,.highlight-py,.highlight-python";
//"h1,h2,h3,h4,ul,div.section p,div.highlight-python";
...
$(document).ready(function(){
    ...
    $("a.email_link").hover(function(){
        if ($(this).attr("href") == null||$(this).attr("href") == '') {
            ...
            $(this).attr("href"
                , "https://github.com/lb-crx/chaos2crx/issues/new?title={chaos2node}"+encodeURIComponent(sub));
